...
export const isValidPixel = (pixel: undefined | Pixel) => typeof pixel !== 'undefined';    
...
export const nearbyAlivePixelsInState = (pixelToCheck: Pixel, size: number, pixels: Pixel[]) => {
...
export const nearbyDeadPixels = (pixel: Pixel, size: number, pixels: Pixel[]) => {
